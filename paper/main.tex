...
operator mathematics.  The native path already provides complete forward and
analytic backward execution for the default operator, while leaving clear
systems headroom.  FlashAttention-style specialization and autotuning across
batch and head shapes, sequence lengths, ranks, and GPU generations offer a
direct route to further wall-clock gains.  The reported measurements therefore
characterize the current implementation, not a performance ceiling for LSSO.
The present empirical evidence covers genomic
